...
func configPath() (string, error) {
	...
	// user session config file will be stored in data directory
	cwd, err := os.Getwd()
	...
	// store the current session of user in /root/data/config.json
...
func Save(sessionId string, expirationTime string) error {
